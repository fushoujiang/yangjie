package com.example.yangjie.monitor;
...
public class ThreadPoolMonitor extends ThreadPoolExecutor {
    ...
    protected void beforeExecute(Thread t, Runnable r) {
        ...
        LOGGER.info("beforeExecute key:{},value:{}",String.valueOf(r.hashCode()),new Date());
    }
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        if (Objects.isNull(startDate)){
            LOGGER.info("startDate is null key:{}",String.valueOf(r.hashCode()));
        }
    ...
    public static final ThreadPoolExecutor dsfExecutor = new ThreadPoolExecutor(1,
            1 ,
            1000L,
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        List<Callable<Boolean>> list = new ArrayList<>(100000);
        for (int i = 0; i < 100000; i++) {
            final int  date = i;

            Callable<Boolean> sellerGrabOrderCaller = () -> {
                System.out.println(dsfExecutor.getQueue().size());
                System.out.println(date);
                return true;
            };
            list.add(sellerGrabOrderCaller);
        }
